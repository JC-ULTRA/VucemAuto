...
public class MainPage40401 {
    ...
    //DATOS TRAMITE
    public SelenideElement labelDatosTramite = $x("/html/body/main/div/div[4]/div/form/div[2]/ul/li[2]/a/label");
    public SelenideElement selectTipoCAAT = $x("//*[@id=\"solicitud.solicitante.ideGenerica1\"]");
    public SelenideElement selectCodigoTransportacion = $x("//*[@id=\"solicitud.ideCodTransportacionAerea\"]");
    public SelenideElement inputCodigo = $x("//*[@id=\"solicitud.codIataIcao\"]");
