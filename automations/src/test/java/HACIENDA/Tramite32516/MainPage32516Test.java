...
public class MainPage32516Test {
    ...
    public void Proceso32516() {
        ...
        JCheckBox autorizacionCheckBox = new JCheckBox("ProcesoAutorizacion32516");
        JCheckBox confirmacionCheckBox = new JCheckBox("ProcesoConfirmarNotificaciónResolucion32516");
        ...
        if (autorizacionCheckBox.isSelected()) selectedMethods.add("ProcesoAutorizacion32516");
        if (confirmacionCheckBox.isSelected()) selectedMethods.add("ProcesoConfirmarNotificaciónResolucion32516");
...
//            // Ingreso y selección de trámite
            ...
            mainPage32516.linkEnvioAvisos.click();
            mainPage32516.linkAvisoHechos.click();
            //DATOS SOLICITANTE
            try {
            ...
            mainPage32516.btmAnexar.click();sleep(4000);
            Selenide.sleep(8000);
