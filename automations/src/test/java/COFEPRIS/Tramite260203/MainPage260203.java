...
public class MainPage260203 {
    ...
    public SelenideElement Tramite260203 = $x("//*[@id=\"servicios\"]/ul/li/ul/li[2]/ul/li[3]/a");
...
// Agregar Mercancía
    ...
    public SelenideElement selectMercanciaClasificacionProducto = $x("//*[@id='mercanciaGrid.idClasificacionProducto']");
    ...
    public SelenideElement inputDenominacionDistintiva = $x("//*[@id=\"idDenominacionComunInternacional\"]");
...
//País origen
    ...
    public SelenideElement btnDesplegarInfoPaisOrigen = $x("//*[@id=\"input26\"]");
...
//País procedencia
    public SelenideElement btnDesplegarInfoPaisProcedencia = $x("//*[@id=\"input33\"]");

    public SelenideElement buttonResolution2 = $x("//button[@aria-controls='panel-listaPaisesDeProcedencia']");

    public SelenideElement selectPaisProcedencia = $x("//*[@id=\"paisesDeProcedencia\"]");
    ...
    public  SelenideElement btnDesplegarInfoUsoEspecifico = $x("//*[@id=\"input40\"]");
    ...
    //Informacion General 2 Mercancia

    public SelenideElement selectFromaFarmaceutica = $x("//*[@id=\"mercanciaGrid.idFormaFarmaceutica\"]");

    public SelenideElement NumeroRegistroSanitario = $x("//*[@id=\"registroSanitario\"]");

    public SelenideElement MarcasDistintivas = $x("//*[@id=\"marcasDistintivas\"]");

    public SelenideElement PresentacionFarmaceuticaTipoEnvase = $x("//*[@id=\"presentacionDetalle\"]");

    public SelenideElement btnAgregarDetalleMercancia = $x("//*[@id=\"btnAgregarMercancias\"]");
    ...
    public SelenideElement btnAdjuntarDoc = $x("//*[@id=\"docs\"]/tbody/tr[10]/td[2]/div/input[2]");
