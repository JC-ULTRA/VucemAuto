...
public class MainPage260515 {
    ...
    public SelenideElement elementoTramite260515 = $x("//*[@id=\"servicios\"]/ul/li/ul/li[5]/ul/li[14]/a");
...
//Agregar S.C.I.A.N.
    ...
    public SelenideElement NumLicenciaSanitaria = $x("//*[@id=\"numeroLicencia\"]");
...
//País origen
    ...
    public SelenideElement btnAgregarPaisOrigen = $x("//input[@name='add' and contains(@onclick, 'paisesDeOrigen')]");
//País procedencia
