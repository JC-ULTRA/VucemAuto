...
//País origen
    ...
    public SelenideElement listaSeleccionPaisOrigen = $x("//*[@id=\"paisesDeOrigen1\"]");
    public SelenideElement inputAdd = $x("//input[@name='add' and contains(@onclick, 'paisesDeOrigen')]");
...
//País procedencia
    ...
    public SelenideElement listaSeleccionPaisProcedencia = $x("//*[@id=\"paisesDeProcedencia1\"]");
    ...
    //Agregar o Modificar Fabricante
    ...
    //Agregar y Modificar facturador
    ...
    public SelenideElement btnModificarFacturador = $x("//*[@id=\"jqg_gridTerceros_TIPERS_FAC_0\"]");
