...
public class MainPage260903 {
    ...
    public SelenideElement datosSolicitud = $x("/html/body/main/div[1]/div[4]/div[1]/div[6]/form/div[1]/ul/li[2]/a");
    ...
    public SelenideElement paisOrigenMod = $x("//*[@id=\"input27\"]");
    ...
    public SelenideElement selecPaisO = $x("/html/body/main/div[1]/div[4]/div[5]/form/div[4]/div[1]/div/div[2]/div/div/div[1]/div[2]/select/option[10]");
    ...
    public SelenideElement paisProcedenciaMod = $x("//*[@id=\"input34\"]");
    ...
    public SelenideElement selecPaisProc = $x("/html/body/main/div[1]/div[4]/div[5]/form/div[4]/div[2]/div/div[2]/div/div/div[1]/div[2]/select/option[4]");
    ...
    public SelenideElement usoEspecifico = $x("//*[@id=\"input41\"]");
    public SelenideElement usoAgregarTodos = $x("/html/body/main/div[1]/div[4]/div[5]/form/div[4]/div[3]/div/div[2]/div/div/div[2]/div/div/input[1]");
    public SelenideElement formaFarmaceutica = $x("//*[@id=\"mercanciaGrid.idFormaFarmaceutica\"]");
    public SelenideElement numRegistroSanitario = $x("//*[@id=\"registroSanitario\"]");
    public SelenideElement marcasDistintivas = $x("//*[@id=\"marcasDistintivas\"]");
    public SelenideElement presentacionFarmaceutica = $x("//*[@id=\"presentacionDetalle\"]");
    ...
    public SelenideElement selecFabricante = $x("/html/body/main/div[1]/div[4]/div[1]/div[6]/form/div[1]/div/div[3]/div[3]/div/div[1]/table/tbody/tr/td/div/div[3]/div[3]/div/table/tbody/tr[2]/td[1]/input");
    public SelenideElement modFabricante = $x("//*[@id=\"modificarTercero_TIPERS_FAB\"]");
    public SelenideElement modRSocial = $x("//*[@id=\"terceros_rSocial\"]");
    public SelenideElement codigoPostalMod = $x("//*[@id=\"terceros_codPostal1\"]");
    public SelenideElement coloniaEquivalente = $x("//*[@id=\"terceros_coloniaEquiv\"]");
    public SelenideElement calleMod = $x("//*[@id=\"terceros_calle\"]");
    public SelenideElement guardarMod = $x("//*[@id=\"btnGuardarFrmDatosTercero\"]");
    public SelenideElement selecDestinatarioFinal = $x("/html/body/main/div[1]/div[4]/div[1]/div[6]/form/div[1]/div/div[3]/div[5]/div/div[1]/table/tbody/tr/td/div/div[3]/div[3]/div/table/tbody/tr[2]/td[1]/input");
    public SelenideElement modDestinatario = $x("//*[@id=\"modificarTercero_TIPERS_DES\"]");
    public SelenideElement selecProveedor = $x("/html/body/main/div[1]/div[4]/div[1]/div[6]/form/div[1]/div/div[3]/div[7]/div/div[1]/table/tbody/tr/td/div/div[3]/div[3]/div/table/tbody/tr[2]/td[1]/input");
    public SelenideElement modProveedor = $x("//*[@id=\"modificarTercero_TIPERS_PVD\"]");
    public SelenideElement selecFacturador = $x("/html/body/main/div[1]/div[4]/div[1]/div[6]/form/div[1]/div/div[3]/div[9]/div/div[1]/table/tbody/tr/td/div/div[3]/div[3]/div/table/tbody/tr[2]/td[1]/input");
    public SelenideElement modFacturador = $x("//*[@id=\"modificarTercero_TIPERS_FAC\"]");
    /// Pago de Derechos
