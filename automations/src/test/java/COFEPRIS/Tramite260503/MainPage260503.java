...
public class MainPage260503 {
    ...
    public SelenideElement linkPermisoImportPlagNutriVegTox = $x("/html/body/main/div/div[3]/div/div[6]/ul/li/ul/li[5]/a");//*[@id="servicios"]/ul/li/ul/li[5]/a/span
    public SelenideElement elementoTramite260503 = $x("//*[@id=\"servicios\"]/ul/li/ul/li[5]/ul/li[3]/a");
    ...
    //Aduana entrada
    public SelenideElement selectAduanaEntrada = $x("//*[@id=\"origenlistaOrigen1\"]");
    ...
    public SelenideElement btnDesplegarInfoPaisProductorActivo= $x("//*[@id=\"accordion\"]/div/div[1]/button");
    public SelenideElement buttonResolution = $x("//button[@href='#panel-listaPaisesDeOrigen']");
    public SelenideElement selectPaisProductorActivo= $x("//*[@id=\"paisesFabricaIngredienteActivo\"]");
    public SelenideElement btnAdd = $x("//*[@id=\"panel-listaPaisesFIA\"]/div/div/div[2]/div/div/input[2]");

    //País donde se elabora el producto
    public SelenideElement btnDesplegarInfoPaisElaboraProducto = $x("/html/body/main/div[1]/div[4]/div[5]/form/div[4]/div[2]/div/div[1]/button");
    public SelenideElement buttonResolution2 = $x("//button[@aria-controls='panel-listaPaisesDeProcedencia']");//*[@id="panel-listaPaisesFP"]/div/div/div[2]/div/div/input[2]
    public SelenideElement selectPaisElaboraProducto = $x("//*[@id=\"paisesFormulaProducto\"]");
    public SelenideElement btnAdd2 = $x("//*[@id=\"panel-listaPaisesFP\"]/div/div/div[2]/div/div/input[2]");

    //Pais Proveedor
    public SelenideElement btnDesplegarInfoPaisProveedor = $x("/html/body/main/div[1]/div[4]/div[5]/form/div[4]/div[3]/div/div[1]/button");
    public SelenideElement selectPaisProveedor = $x("//*[@id=\"paisesDeOrigen\"]");
    public SelenideElement btnAdd3 = $x("//*[@id=\"panel-listaPaisesDeOrigen\"]/div/div/div[2]/div/div/input[2]");

    //País de procedencia/País del último puerto de embarque
    public SelenideElement btnDesplegarInfoPaisEmbarque = $x("/html/body/main/div[1]/div[4]/div[5]/form/div[4]/div[4]/div/div[1]/button");
    public SelenideElement selectPaisEmbarque = $x("//*[@id=\"paisesDeProcedencia\"]");
    public SelenideElement btnAdd4 = $x("//*[@id=\"panel-listaPaisesDeProcedencia\"]/div/div/div[2]/div/div/input[2]");

    //Clasificacion Toxicológica y Objeto importación
    public SelenideElement selectClasficacionTox = $x("//*[@id=\"mercanciaGrid.clasificacionToxicologica.idClasificacionToxicologicaTipoTramite\"]");
    ...
    //Datos Personales
    public SelenideElement btnGuardarTercerosFormulador = $x("//*[@id=\"btnGuardarFrmDatosTercero\"]");
    ...
    public SelenideElement btnGuardarTercerosProveedor = $x("//*[@id=\"btnGuardarFrmDatosTercero\"]");
    ...
    public SelenideElement btnAdjuntarDoc = $x("//*[@id=\"docs\"]/tbody/tr[7]/td[2]/div/input[2]");
