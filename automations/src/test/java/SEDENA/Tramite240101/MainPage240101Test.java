...
public class MainPage240101Test {
    ...
    TramitesFirmasLG tramite240101F = new TramitesFirmasLG(
    ...
    public void Proceso240101() {
        ...
        JCheckBox verificarCheckBox = new JCheckBox("ProcesoVerifica240101");
        JCheckBox autorizarCheckBox = new JCheckBox("AutorizarDictamen240101");
        JCheckBox confirmarCheckBox = new JCheckBox("ConfirmarNotificacion240101");
        ...
        if (dictamenCheckBox.isSelected()) selectedMethods.add("ProcesoVerifica240101");
        if (dictamenCheckBox.isSelected()) selectedMethods.add("AutorizarDictamen240101");
        if (dictamenCheckBox.isSelected()) selectedMethods.add("ConfirmarNotificacion240101");
...
//            // Ingreso y selección de trámite
            ...
            if (selectedMethods.contains("ProcesoDictamen240101")) {
                EvaluarSolicitud(folioNumber);
            }
            if (selectedMethods.contains("ProcesoVerifica240101")) {
                VerificaDictamen(folioNumber);
            }
            if (selectedMethods.contains("AutorizarDictamen240101")) {
                AutorizarDictamen(folioNumber);
            }
            if (selectedMethods.contains("ConfirmarNotificacion240101")) {
    ...
    public void EvaluarSolicitud(String folioNumber) {
        ...
        loginFirmSoli.loginFun(tramite240101F);sleep(4000);
        ConDBReasigSolFun.processFolio(folioNumber, FunRFC);sleep(4000);
        mainPage240101.iniciofun.click();
        mainPage240101.numfolio.sendKeys(folioNumber);sleep(1500);
        mainPage240101.btnBuscarFolio.click();sleep(4500);
        ...
        mainPage240101.inputDictamenAceptado.click();
        mainPage240101.justificacionRequerimiento.setValue("PRUEBAS QA");sleep(2000);
        Selenide.executeJavaScript("arguments[0].value = '10/04/2026';",mainPage240101.inputFechaFinVig);sleep(100);
        $("input[name='mostrarFirma'][value='Guardar y Firmar']").click();sleep(5000);
        loginFirmSoli.firmaFun(tramite240101F);sleep(2000);
    ...
    public void VerificaDictamen(String folioNumber) {
        ...
        ConDBReasigSolFun.processFolio(folioGenerado, rfcEmpleado);
        ConDBReasigSolFun.processFolio(folioNumber, FunRFC);sleep(5000);
        mainPage240101.iniciofun.click();sleep(3000);
        mainPage240101.numfolio.sendKeys(folioNumber);sleep(1500);
        mainPage240101.btnBuscarFolio.click();sleep(4500);
        ...
        loginFirmSoli.firmaFun(tramite240101F);sleep(8000);
    }
    ...
    public void ConfirmarNotificacion(String folioNumber) {
        ...
        loginFirmSoli.login(tramite240101);sleep(3000);
        mainPage240101.SelecRol.sendKeys("Persona Moral");sleep(1000);
        mainPage240101.Btnacep.click();
        mainPage240101.inicioFolio.sendKeys(folioNumber);sleep(15000);
        ...
        loginFirmSoli.firma(tramite240101);sleep(1000);sleep(4000);
    }
    ...
    public void guardarFolioEnArchivo(String folioNumber) {
        String rutaArchivo = "C:\\VucemAuto\\automations\\folios_generados240101.txt";
