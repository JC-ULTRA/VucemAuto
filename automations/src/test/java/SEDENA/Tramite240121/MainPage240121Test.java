...
public class MainPage240121Test {
    ...
    public void Proceso240121() {
        ...
        JCheckBox autorizacionCheckBox = new JCheckBox("ProcesoAutorizacion240121");
        JCheckBox confirmacionCheckBox = new JCheckBox("ProcesoConfirmarNotificaciónResolucion240121");
        ...
        if (autorizacionCheckBox.isSelected()) selectedMethods.add("ProcesoAutorizacion240121");
        if (confirmacionCheckBox.isSelected()) selectedMethods.add("ProcesoConfirmarNotificaciónResolucion240121");
...
//            // Ingreso y selección de trámite
            ...
            mainPage240121.btmAnexar.click();sleep(4000);
            Selenide.sleep(4000);
            mainPage240121.btnCerrar.click();
            Selenide.sleep(2000);
            mainPage240121.inputSiguiente.click();sleep(3000);
            //FIRMAR SOLICITUD
            loginFirmSoli.firma(tramite240121);
            Selenide.sleep(2000);
