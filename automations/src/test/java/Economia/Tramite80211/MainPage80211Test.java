...
public class MainPage80211Test {
    MainPage80211 mainPage80211 = new MainPage80211();
    ...
    TramitesFirmasLG tramite80211  = new TramitesFirmasLG(
    ...
    TramitesFirmasLG tramite80211Fun  = new TramitesFirmasLG(
    ...
    public void Proceso80211() {
        ...
        ejecutarProcesoNRunnable(() -> {
            loginFirmSoli.login(tramite80211);
            ...
            $(By.linkText("Ampliación Registro de empresas terciarizadas")).shouldBe(visible).click();
            ...
            mainPage80211.tabEmpresas.click();
            mainPage80211.rfc.sendKeys("AFC000526BJ2");
            mainPage80211.estado.sendKeys("CHIHUAHUA");sleep(1000);
            $("[name='buscarPlantasTerciarizadoras'][value='Buscar terciarizadas']").shouldBe(visible).click();
            mainPage80211.selecionarPlanta1.click();
            mainPage80211.btnAgregarPlanta.click();sleep(10000);
            metodos.scrollIncremento(1);
            mainPage80211.btnGuardarSoli.click();
            mainPage80211.btnContinuarDocs.click();
            metodos.cargarDocumentos();
            mainPage80211.btnAdjuntar.click();
            mainPage80211.MensajeCarga.shouldNotBe(Condition.visible, Duration.ofSeconds(179)); sleep(1000);
            mainPage80211.btnCerrar.shouldBe(visible).doubleClick();
            mainPage80211.btnContinuarPaso3.click();
            loginFirmSoli.firmaFun(tramite80211);sleep(3200);
            String folioText = mainPage80211.folio.getText();
    ...
    public void ProcesoGenerarDictamen(String folioNumber){
        ...
        loginFirmSoli.loginFun(tramite80211Fun);
        $(By.cssSelector("img[src*='icoInicio.png']")).click();
        ConDBReasigSolFun.processFolio(folioNumber, FunRFC);
        mainPage80211.numfolio.sendKeys(folioNumber);sleep(5000);
        mainPage80211.btnBuscarFolio.doubleClick();sleep(10500);
        ...
        mainPage80211.justificacionDictamen.sendKeys("PRUEBAS QA ULTRASIST");
        mainPage80211.firmarDictamen.click();
        loginFirmSoli.firmaFun(tramite80211Fun);sleep(5000);
    }
    ...
    public void ProcesoConfirmarNotificacion(String folioNumber){
        ...
        loginFirmSoli.login(tramite80211);
        mainPage80211.inicioFolio.sendKeys(folioNumber);sleep(2500);
        $("input[type='button'][value='Buscar']").click();
        metodos.scrollIncremento(1);
        $$(By.cssSelector("td[role='gridcell']")).findBy(Condition.text(folioNumber)).doubleClick();
        mainPage80211.btnContinuarConfirmacion.click();sleep(1000);
        loginFirmSoli.firma(tramite80211);sleep(1000);sleep(4000);
    }
    ...
    public void guardarFolioEnArchivo(String folioNumber) {
        String rutaArchivo = "C:\\VucemAuto\\automations\\folios_generados80211.txt";
