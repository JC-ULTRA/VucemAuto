...
public class MainPage80206 {
    ...
    public SelenideElement btnAgregarFraccionE = $x("//input[@name='agregarFraccion' and contains(@onclick, 'Exportacion')]");
    ...
    public SelenideElement inputclic = $x("/html/body/main/div/div[4]/div/form[1]/div[2]/div/div[2]/div[4]/div[2]/div/div");
    public SelenideElement btnAgregarFraccionI = $x("//input[@name='agregarFraccion' and contains(@onclick, 'Importacion')]");
