...
//            String folioNumber = obtenerFolio.obtenerFolio(folioText);
    ...
    public void ejecutarRutaAlTramite(){
        ...
        mainPage110223.Tramites.sendKeys("Solicitudes nuevas"); sleep(1000);
        mainPage110223.SoliNew.click(); sleep(1000);
        mainPage110223.Economia.click(); sleep(1000);
        mainPage110223.CertificadoOrigen.click(); sleep(1000);
        mainPage110223.ValidacionCertificadosOrigen.click(); sleep(1000);
        mainPage110223.Tramite110223.click(); sleep(1000);
    ...
    public void ejecutarHistoricoProductores(){
        mainPage110223.HproductoresPest.click(); sleep(1000);
        mainPage110223.CheckProductorConfidenciales.click(); sleep(1000);
        mainPage110223.CheckProductorMismaPersona.click(); sleep(1000);
        mainPage110223.CheckInfoProdExport.click(); sleep(1000);
        mainPage110223.btnSeleccionar.click(); sleep(2000);
    }
